...
import 'package:burc_yorum/main.dart';
...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //backgroundColor: Color(0xFF84047C),
      body: Container(
          ...
          children: <Widget>[
              ...
              child: FadeAnimation(1, Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('resim/one.png'),
                        fit: BoxFit.cover
                    )
                ),
              )),
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("Hoşgeldiniz",
                    style: TextStyle(color: Colors.white, fontSize: 50),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Burçların Büyülü Dünyasında \nİyi Eğlenceler..",
